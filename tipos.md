...
Las variables se usan para almacenar datos que puede usar un programa mientras se ejecuta. Cada variable tiene un tipo de dato que define qué tipo de información puede guardar.
...
* **boolean:** almacena valores true o false (falso o verdadero).
